...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [0] = LAYOUT(
        ...
        KC_LCTL,    KC_Z,       KC_X,       KC_C,       KC_V,       KC_B,               KC_N,       KC_M,       KC_COMM,    KC_DOT,     KC_SLSH,    KC_QUOT,
                                MO(2),      KC_SPC,     XXXXXXX,    XXXXXXX,            XXXXXXX,    XXXXXXX,    KC_RSFT,    MO(1)
        ),
    [1] = LAYOUT(
        XXXXXXX,    XXXXXXX,    XXXXXXX,    XXXXXXX,    XXXXXXX,    XXXXXXX,            XXXXXXX,    XXXXXXX,    XXXXXXX,    XXXXXXX,    XXXXXXX,    XXXXXXX,
        KC_TILD,    XXXXXXX,    KC_EXLM,    KC_AT,      KC_HASH,    KC_EQL,             XXXXXXX,    XXXXXXX,    XXXXXXX,    XXXXXXX,    XXXXXXX,    KC_DEL,
        KC_LSFT,    KC_A,       KC_S,       KC_D,       KC_F,       KC_G,               XXXXXXX,    XXXXXXX,    XXXXXXX,    XXXXXXX,    XXXXXXX,    KC_TRNS,
        KC_LCTL,    KC_Z,       KC_X,       KC_C,       KC_V,       KC_B,               XXXXXXX,    XXXXXXX,    XXXXXXX,    XXXXXXX,    KC_BSLS,    KC_TRNS,
                                KC_TRNS,    KC_SPC,     XXXXXXX,    XXXXXXX,            XXXXXXX,    XXXXXXX,    KC_RSFT,    KC_TRNS
        ),
    [2] = LAYOUT(
        XXXXXXX,    XXXXXXX,    XXXXXXX,    XXXXXXX,    XXXXXXX,    XXXXXXX,            XXXXXXX,    XXXXXXX,    XXXXXXX,    XXXXXXX,    XXXXXXX,    XXXXXXX,
        ...
        KC_LCTL,    KC_DOT,     KC_7,       KC_8,       KC_9,       KC_0,               KC_LBRC,    KC_RBRC,    KC_TRNS,    KC_TRNS,    KC_SLSH,    KC_TRNS,
                                KC_LGUI,    KC_ENT,     XXXXXXX,    XXXXXXX,            XXXXXXX,    XXXXXXX,    KC_RSFT,    TO(3)
        ),
    [3] = LAYOUT(
        XXXXXXX,    XXXXXXX,    XXXXXXX,    XXXXXXX,    XXXXXXX,    XXXXXXX,            XXXXXXX,    XXXXXXX,    XXXXXXX,    XXXXXXX,    XXXXXXX,    XXXXXXX,
        XXXXXXX,    XXXXXXX,    XXXXXXX,    KC_INS,     KC_SCRL,    KC_SCRL,            XXXXXXX,    XXXXXXX,    XXXXXXX,    XXXXXXX,    KC_PSCR,    XXXXXXX,
        KC_CAPS,    XXXXXXX,    XXXXXXX,    XXXXXXX,    XXXXXXX,    XXXXXXX,            XXXXXXX,    XXXXXXX,    XXXXXXX,    XXXXXXX,    XXXXXXX,    XXXXXXX,
        XXXXXXX,    XXXXXXX,    XXXXXXX,    XXXXXXX,    XXXXXXX,    XXXXXXX,            NK_TOGG,    XXXXXXX,    XXXXXXX,    XXXXXXX,    XXXXXXX,    XXXXXXX,
                                XXXXXXX,    XXXXXXX,    XXXXXXX,    XXXXXXX,            XXXXXXX,    XXXXXXX,    XXXXXXX,    TO(0)
        )
};
