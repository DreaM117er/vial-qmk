...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [0] = LAYOUT(
        ...
        KC_LCTL,    KC_Z,       KC_X,       KC_C,       KC_V,       KC_B,               KC_N,       KC_M,       KC_COMM,    KC_DOT,     KC_SLSH,    KC_QUOT,
                                MO(2),      KC_SPC,     KC_MS_BTN3, KC_MS_BTN1,         KC_MS_BTN1, KC_MS_BTN2, KC_RSFT,    MO(1)
        ),
    [1] = LAYOUT(
        XXXXXXX,    XXXXXXX,    XXXXXXX,    XXXXXXX,    XXXXXXX,    XXXXXXX,            XXXXXXX,    XXXXXXX,    XXXXXXX,    XXXXXXX,    XXXXXXX,    XXXXXXX,
        KC_TILD,    XXXXXXX,    KC_EXLM,    KC_AT,      KC_HASH,    KC_EQL,             KC_F1,      KC_F2,      KC_F3,      KC_F12,     XXXXXXX,    KC_DEL,
        KC_LSFT,    XXXXXXX,    KC_DLR,     KC_PERC,    KC_CIRC,    KC_UNDS,            KC_F4,      KC_F5,      KC_F6,      KC_F11,     XXXXXXX,    KC_TRNS,
        KC_LCTL,    XXXXXXX,    KC_AMPR,    KC_ASTR,    KC_LPRN,    KC_RPRN,            KC_F7,      KC_F8,      KC_F9,      KC_F10,     KC_BSLS,    KC_TRNS,
                                KC_LGUI,    KC_TRNS,    KC_TRNS,    KC_TRNS,            KC_TRNS,    KC_TRNS,    KC_RSFT,    KC_TRNS
        ),
    [2] = LAYOUT(
        XXXXXXX,    XXXXXXX,    XXXXXXX,    XXXXXXX,    XXXXXXX,    XXXXXXX,            XXXXXXX,    XXXXXXX,    XXXXXXX,    XXXXXXX,    XXXXXXX,    XXXXXXX,
        ...
        KC_LCTL,    KC_DOT,     KC_7,       KC_8,       KC_9,       KC_0,               KC_LBRC,    KC_RBRC,    KC_TRNS,    KC_TRNS,    KC_SLSH,    KC_TRNS,
                                KC_TRNS,    KC_ENT,     KC_TRNS,    KC_TRNS,            KC_TRNS,    KC_TRNS,    KC_RSFT,    TO(3)
        ),
    [3] = LAYOUT(
        XXXXXXX,    XXXXXXX,    XXXXXXX,    XXXXXXX,    XXXXXXX,    XXXXXXX,            XXXXXXX,    XXXXXXX,    XXXXXXX,    XXXXXXX,    XXXXXXX,    XXXXXXX,
