...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [0] = LAYOUT(
        ...
        XXXXXXX, XXXXXXX, XXXXXXX, KC_LALT, MO(2),   KC_SPC,   KC_RSFT,  MO(1),   XXXXXXX, XXXXXXX, XXXXXXX, TO(2), XXXXXXX
        ),
    [1] = LAYOUT(
        ...
        XXXXXXX, XXXXXXX, XXXXXXX, KC_LALT, KC_LGUI,   KC_SPC, KC_RSFT, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, TO(3), XXXXXXX
        ),
    [2] = LAYOUT(
        ...
        XXXXXXX, XXXXXXX, XXXXXXX, OSM(MOD_LALT), KC_LGUI, KC_ENT, KC_RSFT, KC_TRNS, XXXXXXX, XXXXXXX, XXXXXXX, TO(0), XXXXXXX
        ),
    [3] = LAYOUT(
        XXXXXXX, XXXXXXX, XXXXXXX, KC_INS,  KC_SCRL, KC_PAUS,  XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,
